          ...
          <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-md-6 col-12 card-body">
              <div class="mb-4 text-center py-2">
                <h2 class="fw-bold bg-light card-header">Car_name</h2>{{$car->title}}
              </div>
              <div class="mb-4">
                <p class="card-text">
              ...
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Category</span><br>{{$car->category}}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Published:</span>@if($car['Published']==1) yes @else no @endif
                </p>
              </div>
            
              <div class="text-md-end">
                <a href="{{route('car_index')}}" class="btn mt-4 btn-primary text-white fs-5 fw-bold border-0 py-2 px-md-5">
                  Back to All cars
                </a>
              </div>
            </div>
