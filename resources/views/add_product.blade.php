  ...
  <main>
    <div class="container my-5">
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('product_store')}}" method="POST" class="px-md-5" enctype="multipart/form-data">
          @csrf
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">title:</label>
            <div class="col-md-10">
              <input type="text" placeholder="vvv" class="form-control py-2" name="title" value="{{old('title')}}"/>
              @error('title')
